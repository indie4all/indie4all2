...
app.use(session({
    secret: 'mi_secreto', // Una cadena de texto aleatoria para firmar la cookie de sesión
    resave: false, // No se guarda la sesión en cada petición
    saveUninitialized: true // Se guarda una sesión vacía para cada petición sin sesión
  }));
