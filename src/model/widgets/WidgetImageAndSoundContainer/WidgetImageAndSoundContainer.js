...
export default class WidgetImageAndSoundContainer extends WidgetContainerElement {
    ...
    constructor(values) {
        ...
        this.params = values?.params ?? {
            name: WidgetImageAndSoundContainer.label + "-" + Utils.generate_uuid(),
            help: ""
        };
    ...
    regenerateIDs() {
        super.regenerateIDs();
        this.params.name = WidgetImageAndSoundContainer.label + "-" + Utils.generate_uuid();
    }
