...
export default class WidgetInteractiveVideo extends WidgetItemElement {
    ...
    static type = "element";
    static label = "Interactive Video";
    ...
    constructor(values) {
        super(values);
        this.params = values?.params ?? { name: WidgetInteractiveVideo.label + "-" + Utils.generate_uuid() }
    ...
    regenerateIDs() {
        super.regenerateIDs();
        this.params.name = WidgetInteractiveVideo.label + "-" + Utils.generate_uuid();
    }
