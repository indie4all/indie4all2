...
export default class WidgetModal extends WidgetContainerElement {
    ...
    regenerateIDs() {
        super.regenerateIDs();
        this.params.name = WidgetModal.label + "-" + Utils.generate_uuid();
    }
