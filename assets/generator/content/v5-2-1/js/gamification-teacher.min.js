!function(){const a=io();var t=window.location.pathname.split("/");const i=t[t.length-3],r=i+"-studentlist",d=i+"-step";let l=JSON.parse(sessionStorage.getItem(r))||{};a.emit("join-room",i,"teacher");let c=JSON.parse(sessionStorage.getItem(d))||0,m;const u=$(document).find(".question-container").first(),p=u.hasClass("has-gamification-steps"),e=u.find(".gamification-steps").length;function g(){u.trigger("gamification-step",[c]),p&&c==e-1&&$("#bstep-"+i).addClass("d-none")}function f(){if(0===Object.keys(l).length)return[];let t=Object.keys(l).map(t=>{var e=l[t],t=e.answered;return{id:e.id,username:e.username,time:t?e.time:0,score:t?e.score:0,total:e?.total||0,res:!!t&&e.res}});t.sort((t,e)=>t.time-e.time);var e=t.filter(t=>1===t.score);let i=(0<e.length?e:t)[0].time,s=t[t.length-1].time,n=t.map((t,e,n)=>{let a={...t};a.points=1e3*a.score;t=i===s?0:.2*a.points*(Math.max(0,a.time-i)/(s-i));return a.points=Math.round(a.points-t),a.total+=a.points,a});return n.sort((t,e)=>e.total-t.total),n}a.on("hello",(t,e)=>{a.emit("ack",{id:t,step:c,questions:m}),l[t]||(l[t]={id:t,username:e},sessionStorage.setItem(r,JSON.stringify(l)),$("#student-count").html(Object.keys(l).length))}),a.on("update-user-list",t=>{var e,n,a,i;t.step===c&&(e=t.id,n=t.res,a=t.username,i=t.time,t=t.score,t={...l[e],id:e,res:n,username:a,time:i,score:t,answered:!0},l[e]=t,sessionStorage.setItem(r,JSON.stringify(l)),$("#student-count").html(Object.keys(l).length))});function n(t,s){var e=`
