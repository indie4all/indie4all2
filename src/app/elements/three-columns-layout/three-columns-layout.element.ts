...
import { InputWidgetThreeColumnsLayoutData, WidgetInitOptions } from "../../../types";
import ColumnsLayoutElement from "../columns-layout/columns-layout.element";

export default class ThreeColumnsLayoutElement extends ColumnsLayoutElement {
    ...
    async init(values?: InputWidgetThreeColumnsLayoutData, options: WidgetInitOptions = { regenerateId: false }): Promise<void> {
