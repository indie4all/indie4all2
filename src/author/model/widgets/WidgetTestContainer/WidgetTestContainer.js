...
export default class WidgetTestContainer extends WidgetElement {
    ...
    preview(model) {
        ...
        element.querySelector("span").innerHTML = model.params.name ? model.params.name : this.translate("widgets.Test");
        return element;
    }
