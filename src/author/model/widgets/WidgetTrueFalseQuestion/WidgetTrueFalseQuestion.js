...
export default class WidgetTrueFalseQuestion extends WidgetElement {
    ...
    preview(model) {
        ...
        element.innerHTML = model.data.question ? model.data.question : this.translate("widgets.TrueFalseQuestion.prev");
        return element;
    }
